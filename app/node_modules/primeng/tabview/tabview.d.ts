...
export declare class TabView implements AfterContentInit, AfterViewChecked, BlockableUI {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TabView, "p-tabView", never, { "orientation": "orientation"; "style": "style"; "styleClass": "styleClass"; "controlClose": "controlClose"; "activeIndex": "activeIndex"; }, { "onChange": "onChange"; "onClose": "onClose"; "activeIndexChange": "activeIndexChange"; }, ["tabPanels"], ["*"]>;
}
